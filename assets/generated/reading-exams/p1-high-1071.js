(function registerReadingExamData(global) {
  ...
  "meta": {
    ...
    "frequency": "high",
    "pdfFilename": "",
    "source": "IELTS清洗库 biodiversity-de-thi-that-ielts-reading-ielts-reading-recent-actual-test.txt",
  ...
  "questionGroups": [
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q1-2-3-4-5-6-7-anchor\"><h4>Questions 1-7</h4><p>Do the following statements agree with the information given in Reading Passage 1?</p><div class=\"question-item\"><p><strong>1</strong> The term “biodiversity” consists of living creatures and the environment that they live in.</p><div class=\"radio-options\"><label><input name=\"q1\" type=\"radio\" value=\"TRUE\"> TRUE</label><label><input name=\"q1\" type=\"radio\" value=\"FALSE\"> FALSE</label><label><input name=\"q1\" type=\"radio\" value=\"NOT GIVEN\"> NOT GIVEN</label></div></div><div class=\"question-item\"><p><strong>2</strong> There are species that have not been researched because it’s unnecessary to study all creatures.</p><div class=\"radio-options\"><label><input name=\"q2\" type=\"radio\" value=\"TRUE\"> TRUE</label><label><input name=\"q2\" type=\"radio\" value=\"FALSE\"> FALSE</label><label><input name=\"q2\" type=\"radio\" value=\"NOT GIVEN\"> NOT GIVEN</label></div></div><div class=\"question-item\"><p><strong>3</strong> It is not necessary to investigate all creatures in a certain place.</p><div class=\"radio-options\"><label><input name=\"q3\" type=\"radio\" value=\"TRUE\"> TRUE</label><label><input name=\"q3\" type=\"radio\" value=\"FALSE\"> FALSE</label><label><input name=\"q3\" type=\"radio\" value=\"NOT GIVEN\"> NOT GIVEN</label></div></div><div class=\"question-item\"><p><strong>4</strong> The press more often than not focuses on animals well-known.</p><div class=\"radio-options\"><label><input name=\"q4\" type=\"radio\" value=\"TRUE\"> TRUE</label><label><input name=\"q4\" type=\"radio\" value=\"FALSE\"> FALSE</label><label><input name=\"q4\" type=\"radio\" value=\"NOT GIVEN\"> NOT GIVEN</label></div></div><div class=\"question-item\"><p><strong>5</strong> There is a successful case where the cactus moth plays a positive role in the US.</p><div class=\"radio-options\"><label><input name=\"q5\" type=\"radio\" value=\"TRUE\"> TRUE</label><label><input name=\"q5\" type=\"radio\" value=\"FALSE\"> FALSE</label><label><input name=\"q5\" type=\"radio\" value=\"NOT GIVEN\"> NOT GIVEN</label></div></div><div class=\"question-item\"><p><strong>6</strong> Usage of hardwoods is forbidden in some European countries.</p><div class=\"radio-options\"><label><input name=\"q6\" type=\"radio\" value=\"TRUE\"> TRUE</label><label><input name=\"q6\" type=\"radio\" value=\"FALSE\"> FALSE</label><label><input name=\"q6\" type=\"radio\" value=\"NOT GIVEN\"> NOT GIVEN</label></div></div><div class=\"question-item\"><p><strong>7</strong> Agriculture experts advise farmers to plant single crops in the field in terms of sustainable farming.</p><div class=\"radio-options\"><label><input name=\"q7\" type=\"radio\" value=\"TRUE\"> TRUE</label><label><input name=\"q7\" type=\"radio\" value=\"FALSE\"> FALSE</label><label><input name=\"q7\" type=\"radio\" value=\"NOT GIVEN\"> NOT GIVEN</label></div></div></div>",
      "leadHtml": ""
    },
    {
      "groupId": "group-2",
      ...
      "bodyHtml": "<div class=\"group\" id=\"q8-9-10-11-12-13-anchor\"><h4>Questions 8-13</h4><p>Complete the summary below.</p><p>Choose <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.</p><p>Because of the ignorance brought by media, people tend to neglect significant creatures called <strong>8</strong> <input class=\"blank\" name=\"q8\" type=\"text\">. Every creature has diet connections with others, such as <strong>9</strong> <input class=\"blank\" name=\"q9\" type=\"text\">, which provide a majority of foods for other species. In some states of America, the decline in the number of sea otters leads to the boom of <strong>10</strong> <input class=\"blank\" name=\"q10\" type=\"text\">. An impressive case is that imported <strong>11</strong> <input class=\"blank\" name=\"q11\" type=\"text\"> successfully tackles the plant cacti in <strong>12</strong> <input class=\"blank\" name=\"q12\" type=\"text\">. However, the operation is needed for the government to increase its financial support in <strong>13</strong> <input class=\"blank\" name=\"q13\" type=\"text\">.</p></div>",
      "leadHtml": ""
    }
  ],
  "answerKey": {
