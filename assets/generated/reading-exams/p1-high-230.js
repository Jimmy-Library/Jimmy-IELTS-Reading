(function registerReadingExamData(global) {
  ...
  global.__READING_EXAM_DATA__.register("p1-high-230", {
  ...
  "questionGroups": [
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q1-2-3-4-5-6-anchor\"><h4>Questions 1-6</h4><p>Complete the notes below.</p><p>Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p><p>Write your answers in boxes 1-6 on your answer sheet.</p><div class=\"notes-completion\"><h5>The early history of graphite in Britain</h5><ul><li>Graphite was first found below a <strong>1</strong> <input class=\"blank\" name=\"q1\" type=\"text\"> blown down in a storm.</li><li>The first use of graphite was to make marks on <strong>2</strong> <input class=\"blank\" name=\"q2\" type=\"text\">.</li><li>The characteristics of raw graphite:<ul><li>dirty to use because it is so <strong>3</strong> <input class=\"blank\" name=\"q3\" type=\"text\">.</li><li>originally wrapped in <strong>4</strong> <input class=\"blank\" name=\"q4\" type=\"text\"> or animal skin to make it useable as a pencil.</li></ul></li><li>Graphite came to the notice of the government for military and commercial purposes.</li><li>The government completely took over the <strong>5</strong> <input class=\"blank\" name=\"q5\" type=\"text\"> at Borrowdale.</li><li>They employed guards to protect the graphite on its journey south.</li><li>Local people began to <strong>6</strong> <input class=\"blank\" name=\"q6\" type=\"text\"> graphite for the money involved.</li><li>The government passed a law to protect the graphite industry.</li></ul></div></div>",
  ...
  "sourceRefs": {
    "shuiHtml": null,
    "shuiPdf": "ReadingPractice/PDF/230. P1 - The History of the Pencil 铅笔的历史.pdf",
    "ieltsHtml": null
  },
  "audit": {
