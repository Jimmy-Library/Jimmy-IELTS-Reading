...
(function (global) {
     ...
     */
    const BROWSE_MODES = {
        // 默认模式：全部/P1/P2/P3（全部题目均为阅读，按 Part 分类筛选）
        'default': {
            id: 'default',
            filters: [
    ...
    class BrowseController {
        ...
        /**
         * 按分类筛选（默认模式 P1/P2/P3）
         * @param {string} category - 分类 (P1 | P2 | P3)
         */
        filterByCategory(category) {
            ...
            if (typeof global.setBrowseFilterState === 'function') {
                global.setBrowseFilterState(category, 'reading');
            }
            if (typeof global.setBrowseTitle === 'function'
                && typeof global.formatBrowseTitle === 'function') {
                global.setBrowseTitle(global.formatBrowseTitle(category, 'reading'));
            }
